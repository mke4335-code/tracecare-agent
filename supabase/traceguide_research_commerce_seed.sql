...
create table if not exists public.traceguide_orders (
  ...
  status text not null check (status in ('delivered', 'in_transit')),
...
values
  ...
  ('TC-2122', 'cust-ke-demo', 'prod-fresh-sandwich', 1, 'delivered', 0, null, true, '{}'),
...
values
  ('S1-T1', 'glass_damaged_refund', 'cust-ke-demo', 'TC-2048', 'Damaged item', 'Return & Refund', 'Item arrived damaged', 'photos_provided', 'Can prepare refund request after confirmation.'),
  ('S1-T2', 'chilled_yoghurt_change_mind', 'cust-ke-demo', 'TC-2091', 'Change-of-mind chilled food return', 'Return & Refund', 'Customer changed their mind', 'not_required', 'Do not authorise normal return; perishable exception applies unless quality issue exists.'),
  ('S1-T3', 'damaged_food_return', 'cust-ke-demo', 'TC-2104', 'Damaged food item', 'Return & Refund', 'Food arrived damaged', 'not_added', 'Ask for photo evidence or human review before refund request.'),
  ('S2-T1', 'glass_container_broken', 'cust-ke-demo', 'TC-2118', 'Broken lid', 'Replacement or refund', 'Lid was broken on arrival', 'photos_provided', 'Can prepare replacement or refund request after confirmation.'),
  ('S2-T2', 'fresh_sandwich_change_mind', 'cust-ke-demo', 'TC-2122', 'Change-of-mind fresh food return', 'Return & Refund', 'Customer changed their mind', 'not_required', 'Do not authorise normal return; fresh food exception applies unless quality issue exists.'),
